    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(MainActivity.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(MainActivity.this, "Transaction successful."+status, Toast.LENGTH_SHORT).show();
               ...
               // Log.d("UPI", "responseStr: "+approvalRefNo);
                ...
                Toast.makeText(MainActivity.this, "Payment cancelled by user."+status, Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(MainActivity.this, "Transaction failed.Please try again"+status, Toast.LENGTH_SHORT).show();
            }
        } else {
